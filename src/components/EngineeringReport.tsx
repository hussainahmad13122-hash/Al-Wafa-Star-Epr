...
export const AVAILABLE_ADDABLE_CATEGORIES: {
  id: string;
  labelBN: string;
  labelEN: string;
  labelAR: string;
  ...
  },
  {
    ...
    labelEN: "OFFICE AREA",
    labelBN: "অফিস এরিয়া",
    labelAR: "منطقة المكاتب",
    icon: "📍",
  },
  {
    id: "pantry_kitchen",
    labelEN: "PANTRY & KITCHEN",
    labelBN: "প্যান্ট্রি ও কিচেন",
    labelAR: "المطبخ والبانتري",
    icon: "📍",
  },
  {
    id: "washroom_toilets",
    labelEN: "WASHROOM & TOILETS",
    labelBN: "ওয়াশরুম ও টয়লেট",
    labelAR: "دورات المياه",
    icon: "📍",
  },
  {
    id: "treatment_photo",
    labelEN: "TREATMENT PHOTO",
    labelBN: "ট্রিটমেন্ট ফটো",
    labelAR: "صور المعالجة",
    icon: "📍",
  },
  {
    id: "infestation_photo",
    labelEN: "INFESTATION PHOTO",
    labelBN: "ইনফেস্টেশন ফটো",
    labelAR: "صور الإصابة",
    icon: "📍",
  },
];

export const EMIRATE_HOSPITALS: Record<
  string,
...
> = {
  Dubai: [
    ...
    {
      en: "Aster Hospital Mankhool",
      bn: "অ্যাস্টার হাসপাতাল মানখুল",
      ar: "مستشفى أستر المنخول",
    },
    {
      en: "Mediclinic City Hospital",
      bn: "মেডিক্লিনিক সিটি হাসপাতাল",
      ar: "مستشفى ميدكليك سيتي",
    },
    {
      en: "King's College Hospital",
      bn: "কিংস কলেজ হাসপাতাল",
      ar: "مستشفى كينغز كوليج",
    },
    {
      en: "Saudi German Hospital Dubai",
      bn: "সৌদি জার্মান হাসপাতাল দুবাই",
      ar: "المستشفى السعودي الألماني دبي",
    },
    {
      en: "Prime Hospital Al Garhoud",
      bn: "প্রাইম হাসপাতাল আল গারহুদ",
      ar: "مستشفى برايم القرهود",
    },
  ],
  "Abu Dhabi": [
    {
      en: "Sheikh Shakhbout Medical City (SSMC)",
      bn: "শেখ সাখবুত মেডিকেল সিটি",
      ar: "مدينة الشيخ شخبوط الطبية",
    },
    {
      en: "Cleveland Clinic Abu Dhabi",
      bn: "ক্লিভল্যান্ড ক্লিনিক আবুধাবি",
      ar: "كليفلاند كلينك أبوظبي",
    },
    {
      en: "Burjeel Hospital Abu Dhabi",
      bn: "বুর্জিল হাসপাতাল আবুধাবি",
      ar: "مستشفى برجيل أبوظبي",
    },
    {
      en: "NMC Royal Hospital Abu Dhabi",
      bn: "এনএমসি রয়েল হাসপাতাল",
      ar: "مستشفى إن إم سي رويال",
    },
    {
      en: "LLH Hospital Abu Dhabi",
      bn: "এলএলএইচ হাসপাতাল আবুধাবি",
      ar: "مستشفى إل إل إتش",
    },
    {
      en: "Lifeline Hospital Abu Dhabi",
      bn: "লাইফলাইন হাসপাতাল আবুধাবি",
      ar: "مستشفى لايف لاين",
    },
  ],
  Sharjah: [
    {
      en: "Al Qassimi Hospital Sharjah",
      bn: "আল কাসিমি হাসপাতাল শারজাহ",
      ar: "مستشفى القاسمي الشارقة",
    },
    {
      en: "Kuwait Hospital Sharjah",
      bn: "কুয়েত হাসপাতাল শারজাহ",
      ar: "مستشفى الكويت الشارقة",
    },
    {
      en: "University Hospital Sharjah",
      bn: "ইউনিভার্সিটি হাসপাতাল শারজাহ",
      ar: "مستشفى جامعة الشارقة",
    },
    {
      en: "Zulekha Hospital Sharjah",
      bn: "জুলেখা হাসপাতাল শারজাহ",
      ar: "مستشفى زليخة الشارقة",
    },
    {
      en: "NMC Royal Hospital Sharjah",
      bn: "এনএমসি রয়েল হাসপাতাল শারজাহ",
      ar: "مستشفى إن إم سي رويال الشارقة",
    },
    {
      en: "Al Zahra Hospital Sharjah",
      bn: "আল জাহরা হাসপাতাল শারজাহ",
      ar: "مستشفى الزهراء الشارقة",
    },
  ],
  Ajman: [
    {
      en: "Sheikh Khalifa Hospital Masout",
      bn: "শেখ খলিফা হাসপাতাল মাসুত",
      ar: "مستشفى الشيخ خليفة مصفوت",
    },
    {
      en: "Amina Hospital Ajman",
      bn: "আমিনা হাসপাতাল আজমান",
      ar: "مستشفى أمينة عجمان",
    },
    {
      en: "Sheikh Khalifa Hospital - General",
      bn: "শেখ খলিফা জেনারেল হাসপাতাল আজমান",
      ar: "مستشفى الشيخ خليفة بن زايد",
    },
    {
      en: "Thumbay University Hospital",
      bn: "থুম্বে ইউনিভার্সিটি হাসপাতাল আজমান",
      ar: "مستشفى ثومبي الجامعي",
    },
    {
      en: "Saudi German Hospital Ajman",
      bn: "সৌদি জার্মান হাসপাতাল আজমান",
      ar: "المستشفى السعودي الألماني عجمان",
    },
  ],
  "Umm Al Quwain": [
    {
      en: "Umm Al Quwain Hospital",
      bn: "উম্ম আল কুয়াইন হাসপাতাল",
      ar: "مستشفى أم القيوين",
    },
    {
      en: "Sheikh Khalifa General Hospital UAQ",
      bn: "শেখ খলিফা জেনারেল হাসপাতাল ইউএকিউ",
      ar: "مستشفى الشيخ خليفة العام",
    },
    {
      en: "Al Khaleej Medical Center UAQ",
      bn: "আল খলিজ মেডিক্যাল সেন্টার",
      ar: "مركز الخليج الطبي أم القيوين",
    },
  ],
  "Ras Al Khaimah": [
    {
      en: "Saqr Hospital RAK",
      bn: "সাকর হাসপাতাল আরএকে",
      ar: "مستشفى صقر رأس الخيمة",
    },
    { en: "RAK Hospital", bn: "আরএকে হাসপাতাল", ar: "مستشفى رأس الخيمة" },
    {
      en: "Al Oraibi Hospital RAK",
      bn: "আল ওরাইবি হাসপাতাল",
      ar: "مستشفى العريبي",
    },
    {
      en: "Ibrahim Bin Hamad Obaidullah Hospital",
      bn: "ইব্রাহিম বিন হামাদ ওবায়দুল্লাহ হাসপাতাল",
      ar: "مستشفى إبراهيم بن حمد عبيدالله",
    },
  ],
  Fujairah: [
    { en: "Fujairah Hospital", bn: "ফুজাইরাহ হাসপাতাল", ar: "مستشفى الفجيرة" },
    {
      en: "Sheikh Khalifa Central Hospital Fujairah",
      bn: "শেখ খলিফা সেন্ট্রাল হাসপাতাল",
      ar: "مستشفى الشيخ خليفة التخصصي الفجيرة",
    },
    {
      en: "Al Sharq Hospital Fujairah",
      bn: "আল শার্ক হাসপাতাল ফুজাইরাহ",
      ar: "مستشفى الشرق الفجيرة",
    },
    {
      en: "GMC Hospital Fujairah",
      bn: "জিএমসি হাসপাতাল ফুজাইরাহ",
      ar: "مستشفى جي إم سي الفجيرة",
    },
  ],
};
...
export default function EngineeringReport({
  ...
  const [activeSegment, setActiveSegment] = useState<
    "list" | "create" | "preview"
  >(previewTargetReport ? "preview" : "list");
  ...
  const [selectedReport, setSelectedReport] =
    useState<SavedEngineeringReport | null>(previewTargetReport || null);
  ...
  useEffect(() => {
    localStorage.setItem(
      "al-wafa-custom-service-types",
      JSON.stringify(customServiceTypes),
    );
  }, [customServiceTypes]);
  ...
  const [includeRecommendationsInOutput, setIncludeRecommendationsInOutput] =
    useState(true);
  const [
    includeTreatmentCorrectiveInOutput,
    setIncludeTreatmentCorrectiveInOutput,
  ] = useState(true);
  const [includeOperationalLogInOutput, setIncludeOperationalLogInOutput] =
    useState(false);
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "al-wafa-custom-purpose-text",
        JSON.stringify(customPurposeText),
      );
    } catch (e) {}
  }, [customPurposeText]);
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "al-wafa-custom-work-details",
        JSON.stringify(customWorkDetails),
      );
    } catch (e) {}
  }, [customWorkDetails]);
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "al-wafa-custom-recommendations",
        JSON.stringify(customRecommendations),
      );
    } catch (e) {}
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "al-wafa-custom-treatments",
        JSON.stringify(customTreatments),
      );
    } catch (e) {}
  }, [customTreatments]);

  const [showOperationalLogsPopup, setShowOperationalLogsPopup] =
    useState(false);
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "al-wafa-custom-operational-logs",
        JSON.stringify(customOperationalLogs),
      );
    } catch (e) {}
      ...
      <div className="absolute top-8 right-0 w-[85vw] sm:w-[450px] md:w-[600px] bg-slate-800 border border-slate-700/60 rounded-xl shadow-2xl p-3 z-50 animate-fadeIn cursor-default text-left">
        ...
        <div className="flex flex-col gap-1.5 max-h-[300px] overflow-y-auto pr-1">
          {list.length === 0 ? (
            ...
            list.map((item, idx) => {
              const isSelected =
                typeof currentText === "string" && currentText.includes(item);
              return (
                <div
                  key={idx}
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "al-wafa-custom-purposes",
        JSON.stringify(customPurposes),
      );
    } catch (e) {
  ...
  const [photosList, setPhotosList] = useState<
    { url: string; caption: string; zone?: string; videoUrl?: string }[]
  >([]);
  const [recommendationPhotosList, setRecommendationPhotosList] = useState<
    { url: string; caption: string; videoUrl?: string }[]
  >([]);
  const [activeCaptureZone, setActiveCaptureZone] =
    useState<string>("Washroom");
  const [zoneComments, setZoneComments] = useState<Record<string, string>>({});
  const [zoneCustomTitles, setZoneCustomTitles] = useState<
  ...
  useEffect(() => {
    handleResizeTextarea(purposeOfVisitTextRef.current);
  }, [purposeOfVisitText]);
  useEffect(() => {
    handleResizeTextarea(locationDetailsRef.current);
  }, [visitLocation]);
  useEffect(() => {
    handleResizeTextarea(workDetailsTextRef.current);
  }, [workDetailsText]);
  useEffect(() => {
    handleResizeTextarea(recommendationTextRef.current);
  }, [recommendationText]);
  useEffect(() => {
    handleResizeTextarea(treatmentCorrectiveTextRef.current);
  }, [treatmentCorrectiveText]);
  useEffect(() => {
    handleResizeTextarea(operationalLogsTextRef.current);
  }, [operationalLogsText]);
  ...
  const [showClearCanvasConfirm, setShowClearCanvasConfirm] =
  ...
  const getPhotoZone = (p: { url: string; caption: string; zone?: string }) => {
    ...
    if (
      caption.includes("treatment") ||
      caption.includes("ট্রিটমেন্ট") ||
      caption.includes("المعالجة")
    ) {
      return "Treatment Photo";
    }
    if (
      caption.includes("infestation") ||
      caption.includes("ইনফেস্টেশন") ||
      caption.includes("الحشرات")
    ) {
      return "Infestation Photo";
    }
    if (
      caption.includes("washroom") ||
      caption.includes("ওয়াশরুম") ||
      caption.includes("دورات")
    ) {
      return "Washroom";
    }
    if (
      caption.includes("kitchen") ||
      caption.includes("কিচেন") ||
      caption.includes("المطابخ")
    ) {
      return "Kitchen";
    }
    if (
      caption.includes("corridor") ||
      caption.includes("করিডোর") ||
      caption.includes("الممرات")
    ) {
      return "Corridors";
    }
    if (
      caption.includes("office") ||
      caption.includes("অফিস") ||
      caption.includes("المكاتب")
    ) {
      return "Office Rooms";
    }
    return "Other";
  ...
  useEffect(() => {
    ...
    setDynamicZones((prev) => {
      ...
      foundZones.forEach((zId) => {
        const isPreset = PRESET_ZONES.some(
          (pz) => pz.id.toLowerCase() === zId.toLowerCase(),
        );
        const isDynamic = next.some(
          (dz) => dz.id.toLowerCase() === zId.toLowerCase(),
        );
  ...
  const [selectedLocationScope, setSelectedLocationScope] =
    useState<string>("");
  ...
  const [activeZoomPhoto, setActiveZoomPhoto] = useState<{
    url: string;
    caption: string;
    source?: "work" | "rec";
    index?: number;
  ...
  const [activeTool, setActiveTool] = useState<
    "pen" | "rect" | "circle" | "arrow" | "text" | "eraser" | "stamp"
  >("pen");
  ...
  const drawAction = (ctx: CanvasRenderingContext2D, action: any) => {
    ...
    if (action.type === "freehand") {
      ...
      ctx.lineTo(
        action.endX - 12 * Math.cos(angle - Math.PI / 6),
        action.endY - 12 * Math.sin(angle - Math.PI / 6),
      );
      ctx.lineTo(
        action.endX - 12 * Math.cos(angle + Math.PI / 6),
        action.endY - 12 * Math.sin(angle + Math.PI / 6),
  ...
  const handlePointerDown = (
    ...
    if (activeTool === "text") {
      const textToUse =
        activeTextToDraw.trim() ||
        (language === "bn" ? "চিহ্নিত স্থান" : "Inspected Area");
      const textAction = {
        type: "text",
        x: coords.x,
        y: coords.y,
  ...
  const handleRotateImage = () => {
    ...
    const originalHeight =
      bgImageRef.current.naturalHeight || bgImageRef.current.height;
  ...
  const handleSaveAnnotatedPhoto = () => {
    ...
    if (
      activeZoomPhoto?.source === "work" &&
      typeof activeZoomPhoto.index === "number"
    ) {
      ...
      try {
        ...
        mediaRecorder.onstop = () => {
          ...
          try {
            ...
            const zoneNameForFile =
              liveCamType === "work"
                ? activeCaptureZone || "Area"
                : "Recommendation";
  ...
  const initNewReportForm = () => {
    ...
    setReportTitle(
      t(
        "Termite Protection & Pest Engineering Report",
        "উইপোকা ও সাধারণ কেমিক্যাল পেস্ট দমন রিপোর্ট",
        "تقرير الهندسة لمكافحة النمل الأبيض والآفات العامة",
      ),
    );
  ...
  const handleUpdateCaption = (
    ...
    if (type === "work") {
      setPhotosList((prev) =>
        prev.map((item, idx) =>
          idx === index ? { ...item, caption: text } : item,
        ),
      );
    } else {
      setRecommendationPhotosList((prev) =>
  ...
  const handleSaveReport = (viewImmediate?: boolean) => {
    ...
    const filteredRecPhotos = recommendationPhotosList.filter(
      (p) => p.url !== "",
    );
    ...
    if (editingReportId) {
      ...
      targetReport = {
        ...
        createdAt:
          savedReports.find((r) => r.id === editingReportId)?.createdAt ||
    ...
    if (existsIndex >= 0) {
      updatedReports = savedReports.map((r) =>
        r.id === targetReport.id ? targetReport : r,
      );
    } else {
    ...
    saveDocument("engineeringReports", targetReport.id, targetReport).catch(
      (e) => {
        console.warn(
          "Firestore save failing on engineeringReports, kept locally:",
          e,
        );
      },
    );
  ...
  const handleEditReportClick = (report: SavedEngineeringReport) => {
    ...
    setIncludeRecommendationsInOutput(
      report.includeRecommendationsInOutput !== false,
    );
    setIncludeTreatmentCorrectiveInOutput(
      report.includeTreatmentCorrectiveInOutput !== false,
    );
    setIncludeOperationalLogInOutput(
  ...
  const confirmDeleteReport = async () => {
    ...
    try {
      ...
      console.warn(
        "Firestore delete failing on engineeringReports, deleted locally:",
        e,
      );
    }
        ...
        try {
          ...
          if (Array.isArray(parsed)) {
            ...
            if (validated.length === 0) {
              alert(
                t(
                  "Invalid backup file or no valid reports found.",
                  "অকার্যকর ব্যাকআপ ফাইল বা কোনো সঠিক রিপোর্ট পাওয়া যায়নি।",
                  "ملف احتياطي غير صالح أو لم يتم العথুর على تقارير صالحة.",
                ),
              );
              return;
            }
            ...
            if (confirmReplace) {
              setSavedReports((prev) => {
                ...
                const filteredNew = validated.filter(
            ...
            alert(
              t(
                "Invalid file schema. Backup content must be an array of reports.",
                "অকার্যকর ফাইল স্কিমা। ব্যাকআপ ফাইলটি অবশ্যই খতিয়ান তালিকা হতে হবে।",
                "صيغة ملف غير صالحة. يجب أن يكون محتوى النسخ الاحتياطية قائمة من التقারير.",
              ),
            );
          }
        } catch (err) {
  ...
  return (
    <div
      id="engineering-report-root"
      className="space-y-6 w-full max-w-7xl mx-auto font-sans text-slate-100 select-none animate-fadeIn pb-12"
    >
      ...
      {isGeneratingPDF && (
        <div className="fixed inset-0 bg-slate-950/95 backdrop-blur-md z-[99999] flex flex-col items-center justify-center p-6 animate-fadeIn text-center select-none">
          ...
          <h3 className="text-lg font-bold tracking-wide text-white mb-2">
            {language === "bn"
              ? "পিডিএফ রিপোর্ট তৈরি হচ্ছে..."
              : "GENERATING SYSTEM PDF REPORT..."}
          </h3>
          <p className="text-xs text-slate-450 max-w-md antialiased leading-relaxed font-mono">
            {pdfProgressText ||
              (language === "bn"
                ? "অনুগ্রহ করে অপেক্ষা করুন, ইমেজ লোড এবং লেআউট সাজানো হচ্ছে..."
                : "Preparing document and high resolution visual assets...")}
          </p>
        </div>
      )}
        ...
        <div id="list-segment-container" className="space-y-6 animate-fadeIn">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-900 border border-slate-850 rounded-3xl p-6 shadow-2xl">
            <div className="space-y-1.5 text-left">
              <span className="text-[10px] uppercase font-mono tracking-widest bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2.5 py-1 rounded-md font-bold">
                🛡️{" "}
                {t(
                  "PEST CONTROL DEPT",
                  "পেষ্ট কন্ট্রোল বিভাগ",
                  "التحكم في الآفات",
                )}
              </span>
              <h2 className="text-2xl font-black text-white tracking-tight">
                {t(
                  "Engineering Service Reports Log",
                  "ইঞ্জিনিয়ারিং সার্ভিস রিপোর্ট বুক",
                  "سجلات تقارير الخدمة",
                )}
              </h2>
              <p className="text-xs text-slate-400 font-medium">
                {t(
                  "Real-time digital inspection logs & sanitization proofs book",
                  "বাস্তবসম্মত ডিজিটাল রিপোর্ট বুক এবং স্যানিটেশন তথ্যভাণ্ডার",
                  "سجلات تفتيش رقمية وإثباتات التعقيم",
                )}
              </p>
            </div>
            ...
            <div className="bg-slate-900/40 border border-slate-850 rounded-3xl p-16 text-center space-y-4 animate-fadeIn">
              ...
              <div className="max-w-md mx-auto space-y-1">
                ...
                <p className="text-[11px] text-slate-500 font-sans leading-relaxed">
                  {t(
                    "Start your work by tapping the green 'CREATE NEW REPORT' button above.",
                    "উপরে সবুজ বোতামে ক্লিক করে পরিদর্শনের রিপোর্ট সাজানো শুরু করুন।",
                    "ابدأ العمل بالضغط على زر إنشاء تقرير جديد بالأعلى.",
                  )}
                </p>
              </div>
            </div>
                      ...
                      >
                        <td className="px-5 py-4 align-middle">
                          <div className="flex flex-col gap-1.5 items-start">
                            <span className="text-[10px] font-mono bg-slate-900 px-2 py-0.5 rounded border border-slate-700 font-bold text-slate-300 uppercase tracking-widest">
                              {report.reportNo}
                            </span>
                            <span className="text-[9px] font-mono text-emerald-400 font-bold bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20 uppercase tracking-wider">
                              {t(
                                report.serviceType || "Routine Visit",
                                report.serviceType || "রুটিন ভিজিট",
                                report.serviceType || "زيارة روتينية",
                              )}
                            </span>
                          </div>
                        </td>
                        <td className="px-5 py-4 align-middle">
                          <div className="flex flex-col">
                            <span className="text-[13px] font-extrabold text-white tracking-tight capitalize">
                              {report.clientName}
                            </span>
            ...
            <div className="bg-[#0B1121] border border-blue-900/50 rounded-[2rem] p-6 sm:p-8 space-y-6 shadow-[0_0_50px_rgba(30,58,138,0.1)] relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 pb-2 justify-between relative z-10">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <div className="relative">
                    <button
                      type="button"
                      onClick={() =>
                        setShowQuickTextPopover(!showQuickTextPopover)
                      }
                      ...
                      title={t(
                        "Insert Work Description Templates",
                        "কাজের বিবরণ টেমপ্লেট ইনসার্ট",
                        "قوالب تفاصيل العمل",
                      )}
                    >
                    ...
                    {showQuickTextPopover && (
                      <div className="absolute left-0 top-10 w-72 bg-[#0B1121] border border-blue-500/30 rounded-2xl shadow-2xl p-2 z-50 animate-fadeIn font-sans space-y-1.5 max-h-[300px] overflow-y-auto">
                        <div className="p-2 border-b border-slate-800 flex justify-between items-center">
                          <span className="text-[10px] font-black tracking-wider uppercase text-[#10B981]">
                            {t(
                              "Select Template",
                              "কাজের বিবরণ নির্বাচন",
                              "اختر القالب",
                            )}
                          </span>
                          <button
                            type="button"
                            onClick={() => setShowQuickTextPopover(false)}
                            className="text-[9px] font-bold text-rose-450 hover:text-rose-405"
                          >
                            [✕]
                          </button>
                        </div>
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <span>
                      📄 {t("All Saved Reports", "সব রিপোর্ট", "كل التقارير")}
                    </span>
                  </button>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div
                    ...
                    className={`space-y-1.5 relative transition-all duration-300 ${
                      validationErrors.reportTitle
                        ? "animate-float-alert border-2 border-sky-500 rounded-xl p-2 bg-sky-500/5"
                        : ""
                    }`}
                  >
                    ...
                    <input
                      ...
                      placeholder={t(
                        "Pest Control Audit, Fumigation, Routine Inspection...",
                        "ক্যাম্পাস অডিট, ফিউমিগেশন, সামগ্রিক পরিদর্শন...",
                        "التحكم في الآفات، تعقيم، تفتيش...",
                      )}
                    ...
                    <div className="bg-[#0B0F19] border border-[#1D4ED8] p-1 rounded-xl shadow-inner h-[42px] items-center w-full">
                      <div className="flex items-center pl-2.5 gap-2 bg-cyan-500 h-full rounded-lg border border-cyan-400">
                        ...
                        <span className="text-[10px] font-black tracking-widest text-[#0B1121] font-sans select-none pl-3 truncate">
                          {customCompanyName
                            ? customCompanyName.toUpperCase().trim()
                            : "AL WAFA STAR PEST CONTROL SERVICE"}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 w-full col-span-1">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div
                        ...
                        className={`flex items-center gap-2 bg-[#1D4ED8] hover:bg-blue-700 transition text-white px-4 py-2.5 rounded-xl border-2 shadow-sm w-full transition-all duration-300 relative h-[46px] ${
                          validationErrors.engineerName
                            ? "animate-float-alert border-blue-400"
                            : ""
                        } ${
                          !engineerName.trim()
                      ...
                      >
                        <span className="text-[10.5px] font-black shrink-0 tracking-tight">
                          ENGINEER:
                        </span>
                        <input
                          type="text"
                  ...
                  >
                    ...
                    <div className="relative flex items-center font-sans">
                      <input
                        ...
                        placeholder={t(
                          "Enter client name or click 🏥 to look up...",
                          "ক্লায়েন্ট নাম লিখুন অথবা 🏥 ক্লিক করে পছন্দ করুন...",
                          "أدخل اسم العميل أو اضغط 🏥 للاختيار...",
                        )}
                      ...
                      >
                        ...
                        <span className="text-[8.5px] font-black tracking-widest font-mono">
                          GET
                        </span>
                      </button>
                    </div>
                                ...
                                if (matched.length === 0) {
                                  return (
                                    <div className="text-[10px] text-slate-500 py-6 text-center font-sans">
                                      {t(
                                        "No hospital presets found matching your query.",
                                        "কোনো মিল পাওয়া যায়নি।",
                                        "لم يتم العثور على أي مستشفى مطابق لعملية البحث.",
                                      )}
                                    </div>
                                  );
                                }
                                  ...
                                  return (
                                    ...
                                    >
                                      <div className="flex flex-col text-left font-sans">
                                        <span className="font-extrabold group-hover:text-emerald-400 transition-colors">
                                          {loc.name}
                                        </span>
                                  ...
                                  return (
                                    ...
                                    >
                                      <div className="flex flex-col text-left font-sans font-sans">
                                        ...
                                        <span className="text-[9.5px] text-slate-400 font-bold uppercase tracking-wider font-mono">
                                          {loc.emirate}
                                        </span>
                                      </div>
                                      <span className="text-[8.5px] font-black bg-[#10B981]/15 text-[#10B981] px-1.5 py-0.5 rounded uppercase font-mono tracking-wider shrink-0">
                          ...
                          {!hospitalSearch.trim() &&
                            activeLocations.filter(
                              ...
                              <p className="text-[10px] text-slate-500 py-4 text-center font-sans">
                                {t(
                                  "No locations found for this Emirate.",
                                  "এই আমিরাতে কোনো সক্রিয় লোকেশন ফাইল করা নেই।",
                                  "لا توجد مستشفيات مضافة في هذه الإمارة.",
                                )}
                              </p>
                            )}
                        </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 w-full font-sans">
                    <div className="space-y-1.5">
                      <label className="text-[10px] uppercase tracking-wider text-slate-400 font-bold font-mono flex items-center justify-between">
                        <span>
                          🛡️{" "}
                          {t("Type of Service", "সার্ভিসের ধরণ", "نوع الخدمة")}
                        </span>
                        <button
                          type="button"
                      ...
                      >
                        ...
                        <option
                          ...
                          className="bg-[#111827] text-yellow-400 font-bold font-sans"
                        >
                          {t(
                            "+ Add Custom Type...",
                            "+ নতুন ধরণের সার্ভিস যোগ...",
                            "+ إضافة خدمة مخصصة...",
                          )}
                        </option>
                      </select>
                        ...
                        <div className="flex items-center gap-1.5 text-[13px] font-black text-slate-800">
                          ...
                          <div className="flex items-center relative hover:bg-yellow-200/60 p-1.5 rounded-lg transition-colors">
                            <select
                              ...
                              onChange={(e) =>
                                updateReportDatePart("day", e.target.value)
                              }
                            ...
                            <span className="text-[8px] text-slate-500 font-bold absolute right-1 pointer-events-none select-none">
                              v
                            </span>
                          </div>
                          ...
                          <div className="flex items-center relative hover:bg-yellow-200/60 p-1.5 rounded-lg transition-colors">
                            <select
                              ...
                              onChange={(e) =>
                                updateReportDatePart("month", e.target.value)
                              }
                              className="bg-transparent text-slate-800 font-extrabold outline-none cursor-pointer appearance-none pr-3 text-center w-[30px] h-[30px] border-none p-0 focus:ring-0 leading-none"
                              style={{
                                WebkitAppearance: "none",
                          ...
                          <div className="flex items-center relative hover:bg-yellow-200/60 p-1.5 rounded-lg transition-colors font-mono">
                            <select
                              ...
                              onChange={(e) =>
                                updateReportDatePart("year", e.target.value)
                              }
                  ...
                  >
                    ...
                    <textarea
                      ...
                      placeholder={t(
                        "All outer regions, specific wards...",
                        "ভবনের চারপাশে, নির্দিষ্ট ওয়ার্ড...",
                        "جميع المناطق الخارجية...",
                      )}
                ...
                <div className="pt-1.5 w-full space-y-1.5 relative">
                  <div className="flex justify-between items-center relative w-full">
                    <div
                      ...
                      onClick={() => setShowPurposePopup(!showPurposePopup)}
                    >
                      <input
                        type="checkbox"
                        ...
                        onChange={(e) =>
                          setIncludePurposeInOutput(e.target.checked)
                        }
                        onClick={(e) => e.stopPropagation()}
                        title={t(
                          "Include in Report Output",
                          "রিপোর্ট আউটপুটে যুক্ত করুন",
                          "تضمين في مخرجات التقرير",
                        )}
                      />
                      ...
                      <div className="absolute top-6 left-0 w-[280px] sm:w-[320px] bg-slate-800 border border-slate-700/60 rounded-xl shadow-2xl p-3 z-50 animate-fadeIn cursor-default z-[55]">
                        ...
                        <div className="flex flex-col gap-1.5 max-h-[300px] overflow-y-auto pr-1">
                          {customPurposes.map((opt, i) => (
                            <div
                              key={i}
                              className="flex group items-center gap-1.5"
                            >
                              <button
                                type="button"
                                onClick={() => {
                          ...
                          {customPurposes.length === 0 && (
                            <div className="text-center p-3 text-[10px] text-slate-500 italic border border-dashed border-slate-700 rounded-lg">
                              {t(
                                ...
                                "কোন আইটেম নেই। উপরে যোগ করুন।",
                                "لا توجد عناصر. أضف واحدًا أعلاه.",
                              )}
                            </div>
                          )}
                        </div>
                    ...
                    <div className="flex items-center">
                      <button
                        type="button"
                        onClick={() =>
                          setShowPurposeTextPopup(!showPurposeTextPopup)
                        }
                      ...
                      {renderCustomDropdown(
                        showPurposeTextPopup,
                        setShowPurposeTextPopup,
                        customPurposeText,
                        setCustomPurposeText,
                        purposeOfVisitText,
                        setPurposeOfVisitText,
                        newPurposeTextInput,
                        setNewPurposeTextInput,
                      )}
                    </div>
                  </div>
                  <textarea
                    ...
                    placeholder={t(
                      "Enter custom purpose of visits here...",
                      "এখানে পরিদর্শনের কাস্টম উদ্দেশ্য লিখুন...",
                      "أدخل الغرض المخصص من الزيارة هنا...",
                    )}
                    className="w-full bg-cyan-100/90 hover:bg-cyan-100 border-2 border-cyan-300 focus:border-[#10B981] placeholder-slate-500 text-slate-900 rounded-xl py-2.5 px-3.5 outline-none font-bold text-[11px] tracking-wide transition-colors shadow-inner resize-none min-h-[42px] overflow-hidden leading-tight"
                  />
                </div>
                ...
                <div className="space-y-5 pt-3">
                  ...
                  >
                    <div className="flex justify-between items-center relative w-full">
                      <label className="text-[10px] uppercase tracking-wider text-slate-300 font-bold font-mono flex items-center gap-1.5 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            setIncludeFindingsInOutput(e.target.checked)
                          }
                          title={t(
                            "Include in Report Output",
                            "রিপোর্ট আউটপুটে যুক্ত করুন",
                        ...
                        />
                        <span className="text-sm">🔍</span>{" "}
                        {t("Inspection", "পরিদর্শন", "تفتيش")}
                      </label>
                      <button
                        type="button"
                        onClick={() =>
                          setShowWorkDetailsPopup(!showWorkDetailsPopup)
                        }
                        className="text-cyan-400 hover:text-cyan-300 transition-colors p-0.5 rounded cursor-pointer relative z-10"
                      >
                        <Settings2 className="w-4 h-4" />
                      ...
                      {renderCustomDropdown(
                        showWorkDetailsPopup,
                        setShowWorkDetailsPopup,
                        customWorkDetails,
                        setCustomWorkDetails,
                        workDetailsText,
                        setWorkDetailsText,
                        newWorkDetailsInput,
                        setNewWorkDetailsInput,
                      )}
                    </div>
                    <textarea
                    ...
                    {validationErrors.workDetailsText && (
                      <span className="absolute -top-10 right-2 bg-sky-600 text-white text-[9px] px-2 py-0.5 rounded shadow-lg font-black animate-pulse z-50 whitespace-nowrap">
                        ⚠️{" "}
                        {t(
                          "Inspection info Required!",
                          "পরিদর্শনের তথ্য আবশ্যক!",
                          "معلومات التفتيش مطلوبة",
                        )}
                      </span>
                    )}
                  </div>
                    ...
                    <div className="flex justify-between items-center relative w-full">
                      <label className="text-[10px] uppercase tracking-wider text-slate-300 font-bold font-mono flex items-center gap-1.5 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            setIncludeRecommendationsInOutput(e.target.checked)
                          }
                          title={t(
                            "Include in Report Output",
                            "রিপোর্ট আউটপুটে যুক্ত করুন",
                        ...
                        />
                        <span className="text-sm">💡</span>{" "}
                        {t("Recommendation", "সুপারিশ", "توصية")}
                      </label>
                      <button
                        type="button"
                        onClick={() =>
                  ...
                  <div className="space-y-1.5 pt-1">
                    <div className="flex justify-between items-center border-b border-red-500/30 pb-0.5 relative w-full">
                      ...
                      <div className="flex items-center gap-1.5 relative">
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            setShowTreatmentPopup(!showTreatmentPopup)
                          }
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setTreatmentCorrectiveText(e.target.value)
                      }
                      placeholder={t(
                        "Enter treatment corrective recommendations...",
                        "সংশোধনমূলক সুপারিশ লিখুন...",
                        "أدخل التوصيات التصحيحية...",
                      )}
                    ...
                    <div className="flex justify-between items-center relative w-full">
                      <label className="text-[10px] uppercase tracking-wider text-slate-300 font-bold font-mono flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            setIncludeOperationalLogInOutput(e.target.checked)
                          }
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          setShowOperationalLogsPopup(!showOperationalLogsPopup)
                        }
                        className="text-cyan-400 hover:text-cyan-300 transition-colors p-0.5 rounded cursor-pointer relative z-10"
                      >
                        <Settings2 className="w-4 h-4" />
                      ...
                      {renderCustomDropdown(
                        showOperationalLogsPopup,
                        setShowOperationalLogsPopup,
                        customOperationalLogs,
                        setCustomOperationalLogs,
                        operationalLogsText,
                        setOperationalLogsText,
                        newOperationalLogsInput,
                        setNewOperationalLogsInput,
                      )}
                    </div>
                    {includeOperationalLogInOutput && (
                      <textarea
                        ...
                        placeholder={t(
                          "Enter operational log details (Type anything you want here, it will not populate automatically)...",
                          "অপারেশনাল লগের বিবরণ লিখুন...",
                          "أدخل تفاصيل سجل العمليات...",
                        )}
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 font-sans pb-3 border-b border-slate-800/45">
                  <div className="flex flex-wrap items-center gap-3 w-full justify-between">
                      ...
                      >
                        <span className="flex items-center gap-1.5 text-emerald-400">
                          ...
                          {selectedCategoryLabel
                            ? t(
                                selectedCategoryLabel.en,
                                selectedCategoryLabel.bn,
                                selectedCategoryLabel.ar,
                              )
                            : t(
                        ...
                        <ChevronDown
                          className={`w-4 h-4 text-emerald-400 transition-transform duration-250 ${isCategorySelectorOpen ? "rotate-180" : ""}`}
                        />
                      </button>
                      ...
                      {isCategorySelectorOpen && (
                        <div className="absolute left-0 mt-2 w-[280px] bg-slate-950 border border-slate-850 rounded-2xl shadow-2xl p-2 z-50 space-y-1 animate-fadeIn font-sans max-h-[320px] overflow-y-auto">
                          {AVAILABLE_ADDABLE_CATEGORIES.map((cat) => {
                            const isAlreadyActive = activeZones.some(
                              (z) =>
                                z.id.toLowerCase() === cat.id.toLowerCase(),
                            );
                            return (
                              <button
                                key={cat.id}
                                ...
                                onClick={() => {
                                  ...
                                  const alreadyExists = activeZones.some(
                                    (z) =>
                                      z.id.toLowerCase() ===
                                      cat.id.toLowerCase(),
                                  );
                              ...
                              >
                                ...
                                {isAlreadyActive && (
                                  <span className="text-[10px] text-[#10B981] font-bold bg-emerald-950/60 px-2 py-0.5 rounded-full border border-emerald-900/40">
                                    ✓
                                  </span>
                                )}
                              </button>
                    ...
                    <span className="text-[10px] uppercase font-mono px-3 py-1 bg-slate-950/80 rounded border border-slate-800 text-emerald-400 font-bold h-[38px] flex items-center justify-center">
                      {t(
                        `Total Attached: ${photosList.length}`,
                        `মোট যুক্ত ছবি: ${photosList.length} টি`,
                        `الصور المرفقة: ${photosList.length}`,
                      )}
                    </span>
                  </div>
                </div>
                  ...
                  {activeZones.length > 0 ? (
                    activeZones.map((zone) => {
                      ...
                      const zonePhotos = photosList.filter((p) => {
                        ...
                        return (
                          detectedZone.toLowerCase() === zone.id.toLowerCase()
                        );
                      });
                      ...
                      return (
                        <div
                          ...
                          className="space-y-3 pb-4 border-b border-slate-800/40 last:border-b-0 transition-all text-left"
                        >
                          ...
                          <div className="flex items-center justify-between border-b border-slate-850 pb-2">
                            <div className="flex items-center gap-1.5 text-left flex-wrap">
                              ...
                              <input
                                ...
                                placeholder={t(
                                  "Edit zone display title...",
                                  "জোনের কাস্টম নাম লিখুন...",
                                  "تحديث اسم المنطقة...",
                                )}
                          ...
                          {zone.id === "Other" && (
                            <div className="animate-fadeIn font-sans pt-1">
                              <input
                                ...
                                onChange={(e) =>
                                  setCustomLocationScope(e.target.value)
                                }
                                placeholder={t(
                                  "✍️ Enter Custom Zone Name (e.g., Server Room)",
                                  "✍️ কাস্টম জোনের নাম লিখুন (যেমন: সার্ভার রুম, লবি ইত্যাদি)...",
                                  "✍️ اكتب اسم المنطقة المخصصة...",
                                )}
                          ...
                          {zonePhotos.length > 0 ? (
                            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 animate-fadeIn">
                              {zonePhotos.map((item, pIdx) => {
                                ...
                                const masterIndex = photosList.findIndex(
                                  (p) => p.url === item.url,
                                );
                            ...
                            <div className="text-[10px] text-slate-600 italic px-0.5 font-sans">
                              {t(
                                ...
                                "এই জোনের জন্য কোনো ছবি তোলা হয়নি",
                                "لم يتم التقاط صور لهذه المنطقة",
                              )}
                            </div>
                          )}
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  if (files && files.length > 0) {
                                    (Array.from(files) as File[]).forEach(
                                      (file) => {
                                        handleAddNewPhoto(
                                          file,
                                          "work",
                    ...
                    <div className="text-center p-8 bg-slate-955/40 rounded-3xl border border-slate-800 font-sans">
                      <p className="text-sm text-slate-400 font-medium">
                        {t(
                          "No active categories selected. Please add one above.",
                          "কোনো সক্রিয় ক্যাটাগরি যুক্ত নেই, উপরে পছন্দের ক্যাটাগরি সিলেক্ট করুন।",
                          "لا توجد تصنيفات نشطة مضافة، يرجى إضافة تصنيف من الأعلى.",
                        )}
                      </p>
                    </div>
                  )}
              ...
              <div className="space-y-4 border-t border-slate-800 pt-6 font-sans">
                <div className="flex justify-between items-center pb-2 border-b border-slate-800/40 font-sans">
                  <div className="text-left">
                    <h3 className="text-xs font-black uppercase tracking-wider text-slate-350">
                      💡{" "}
                      {t(
                        "RECOMMENDATIONS EVIDENCE / ATTACHED PROOFS",
                        "রিকমেন্ডেশন সংক্রান্ত প্রমাণাদি বা ছবি",
                        "إثباتات التوصيات والإجراءات التصحيحية",
                      )}
                    </h3>
                    <p className="text-[10px] text-slate-500 font-medium">
                      {t(
                        "Attach photos related to recommendations or target areas being treated",
                        "রিকমেন্ডেশন বা চিকিৎসা করা হচ্ছে এমন জায়গা বা পদক্ষেপের ছবি যোগ করুন",
                        "أرفق صوراً للمواقع المعالجة أو التوصيات",
                      )}
                    </p>
                  </div>
                  <span className="text-[10px] font-mono px-3 py-1 bg-slate-950 rounded border border-slate-850 text-amber-500 font-bold h-[32px] flex items-center">
                    {t(
                      `Attached: ${recommendationPhotosList.length}`,
                      `যোগ করা হয়েছে: ${recommendationPhotosList.length} টি`,
                      `المرفقة: ${recommendationPhotosList.length}`,
                    )}
                  </span>
                </div>
                ...
                {recommendationPhotosList.length > 0 ? (
                  ...
                  <div className="text-[10px] text-slate-600 italic px-0.5 font-sans text-left">
                    {t(
                      "No recommendation photos captured yet",
                      "কোনো রিকমেন্ডেশন ছবি তোলা হয়নি",
                      "لم يتم التقاط صور لتوصيات المعالجة",
                    )}
                  </div>
                )}
                ...
                <div className="flex items-center gap-2 pt-1 font-sans">
                  ...
                  <button
                    ...
                    onClick={() => {
                      setIsCategorySelectorOpen(false);
                      const defaultName =
                        language === "bn" ? "অফিস করিডর" : "Office Corridor";
                      setNewSlotInput(defaultName);
                      setSlotToCreate({
                        isOpen: true,
                        defaultVal: defaultName,
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-slate-800/60 font-sans">
                ...
                >
                  🚀{" "}
                  {t(
                    "Save & Generate Live Preview",
                    "রিপোর্ট সংরক্ষণ ও ডিরেক্ট প্রিভিউ",
                    "حفظ وتوليد ومعاينة التقرير",
                  )}
                </button>
                <button
                  type="button"
      ...
      {selectedReport && activeSegment === "preview" && (
        <div
          ...
          className="max-w-5xl mx-auto space-y-6 print:space-y-0 print:m-0 print:p-0 animate-fadeIn font-sans"
        >
              ...
              >
                ...
                <div className="relative z-10 flex flex-col w-full h-full font-sans gap-6 print:gap-4">
                  ...
                  <div className="pb-3 flex flex-col items-center gap-1.5 font-sans w-full">
                    <div className="flex items-center gap-4 w-full">
                      ...
                      <div className="flex-1 flex flex-col justify-center select-text">
                        ...
                        <div
                          className="text-[18px] sm:text-[23px] font-extrabold text-black tracking-wide leading-tight text-left"
                          style={{
                  ...
                  <div className="flex flex-col gap-10">
                    {/* Part 1 Content */}
                    <div
                      className="space-y-6 flex flex-col pr-1 w-full"
                      ...
                      <div className="space-y-4 text-[13px] sm:text-[14px] md:text-[14.5px] leading-relaxed text-slate-800 font-sans pl-2 py-2 select-text">
                        <div className="flex flex-col sm:flex-row sm:items-start gap-1">
                          ...
                          <span className="font-semibold text-slate-800 flex-1">
                            {t(
                              "AL WAFA Star – Pest Control",
                              "আল ওয়াফা স্টার – পেস্ট কন্ট্রোল",
                              "نجمة الوفاء – مكافحة الحشرات",
                            )}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start gap-1 pt-2 sm:pt-1">
                          ...
                          <span className="font-extrabold text-slate-900 uppercase tracking-wide flex-1 text-[12.5px] sm:text-[13px]">
                            {t("ENGINEER", "ইঞ্জিনিয়ার", "المهندس/")}{" "}
                            {selectedReport.engineerName.toUpperCase()}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start gap-1 pt-2 sm:pt-1">
                          ...
                          <span className="font-extrabold text-[#111827] uppercase tracking-tight flex-1">
                            {selectedReport.emirate
                              ? selectedReport.emirate.toUpperCase()
                              : ""}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start gap-1 pt-2 sm:pt-1">
                          ...
                          <span className="font-semibold text-slate-800 leading-relaxed capitalize flex-1">
                            {selectedReport.visitLocation ||
                              t(
                                "Outdoor areas around all hospital buildings, Garden areas & Parking areas, All Rodent Bait Stations.",
                                "হাসপাতালের বাইরের দিক, বাগান ও পার্কিং এরিয়া, সব রোডেন্ট টোপ স্টেশন সমূহ।",
                                "المناطق الخارجية حول مباني المستشفى، ومناطق الحدائق والمواقف، وجميع محطات طعوم القوارض.",
                              )}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start gap-1 pt-2 sm:pt-1">
                          <span className="font-extrabold text-slate-900 uppercase w-32 shrink-0">
                            {t(
                              "Type of Visit:",
                              "পরিদর্শনের ধরণ (Type of Visit):",
                              "نوع الزيارة:",
                            )}
                          </span>
                          <span className="font-bold text-slate-800 capitalize flex-1">
                            {t(
                              selectedReport.serviceType || "Routine Visit",
                              selectedReport.serviceType || "রুটিন ভিজিট",
                              selectedReport.serviceType || "زيارة روتينية",
                            )}
                          </span>
                        </div>
                      </div>
                      ...
                      {selectedReport.includePurposeInOutput !== false && (
                        <div className="space-y-4 pt-1">
                          <h3 className="font-serif italic text-indigo-700 font-extrabold text-sm sm:text-base tracking-wide flex items-center gap-1.5 pl-1">
                            {selectedReport.purposeOfVisitLabel
                              ? `1. ${selectedReport.purposeOfVisitLabel}`
                              : t(
                                  "1. Purpose of visits",
                                  "১. পরিদর্শনের উদ্দেশ্য (Purpose of visits)",
                                  "١. الغرض من الزيارة",
                                )}
                          </h3>
                          <ul className="list-disc pl-6 space-y-4 text-[12px] sm:text-[13px] md:text-[13.5px] text-slate-800 font-bold leading-relaxed pr-2 select-text">
                            <li className="marker:text-indigo-600 pl-1 leading-relaxed">
                              ...
                              <span className="font-medium text-slate-700 block mt-1">
                                ...
                                {selectedReport.purposeOfVisitText || " - "}
                              </span>
                            </li>
                          </ul>
                        </div>
                              ...
                              selectedReport.workDetails
                                ...
                                .map((line, idx) => {
                                  ...
                                  return (
                                    <li
                                      key={idx}
                                      className="marker:text-[#ED1C24] whitespace-pre-wrap mb-1.5"
                                    >
                                      {line.trim()}
                                    </li>
                                  );
                            ...
                            {selectedReport.recommendationText
                              ...
                              .map((line, idx) => {
                                ...
                                return (
                                  <li
                                    key={idx}
                                    className="marker:text-amber-500 whitespace-pre-wrap mb-1.5"
                                  >
                                    {line.trim()}
                                  </li>
                                );
                    ...
                    <div className="space-y-6 flex flex-col pr-1 w-full">
                      <h3 className="text-[12.5px] font-black text-indigo-900 uppercase tracking-wider border-b border-slate-200 pb-1 flex items-center gap-2">
                        <span className="bg-indigo-900 text-white text-[9px] w-4.5 h-4.5 rounded-full flex items-center justify-center font-bold">
                          2
                        </span>
                        <span>
                          {t(
                            "Inspection Findings & Field Logs:",
                            "অনুসন্ধান এবং ফিল্ড রেজিস্টার পর্যবেক্ষণসমূহ:",
                            "نتائج التفتيش والملاحظات الميدانية:",
                          )}
                        </span>
                      </h3>
                      ...
                      selectedReport.treatmentCorrectiveText.trim() &&
                      selectedReport.includeTreatmentCorrectiveInOutput !==
                        false ? (
                        <div className="pt-2 border-t border-slate-100">
                            ...
                            {selectedReport.treatmentCorrectiveText
                              ...
                              .map((line, idx) => {
                                ...
                                return (
                                  <li
                                    key={idx}
                                    className="marker:text-red-500 whitespace-pre-wrap mb-1.5"
                                  >
                                    {line.trim()}
                                  </li>
                                );
                      ...
                      {selectedReport.zoneComments &&
                        Object.entries(selectedReport.zoneComments).some(
                          ([_, val]) =>
                          ...
                          <div className="space-y-2 border-t border-slate-100 pt-2.5">
                            <p className="text-[10px] font-extrabold text-[#ED1C24] uppercase tracking-wider">
                              ...
                              {t(
                                "Area-Specific Special Observations:",
                                "জোন ভিত্তিক বিশেষ পর্যবেক্ষণসমূহ:",
                                "ملاحظات تشخيصية محددة للمناطق:",
                              )}
                            </p>
                            <div className="grid grid-cols-2 gap-2 text-[11px] font-sans">
                              {Object.entries(selectedReport.zoneComments).map(
                                ([zoneId, comment]) => {
                                  if (
                                    !comment ||
                                  ...
                                  return (
                                    <div
                                      key={zoneId}
                                      className="p-2 border border-slate-200 bg-slate-50/50 rounded-xl leading-relaxed select-text flex flex-col justify-between"
                                      style={{ breakInside: "avoid" }}
                                    >
                      ...
                      {selectedReport.includeOperationalLogInOutput &&
                        selectedReport.operationalLogs &&
                        selectedReport.operationalLogs.trim() && (
                          <div
                            className="p-4 mt-6 bg-slate-50 border border-slate-200 rounded-xl space-y-1 w-full"
                            style={{ breakInside: "avoid" }}
                          >
                    ...
                    {(() => {
                      const zonesWithPhotos = reportZones.filter((zone) =>
                        allReportPhotos.some(
                          (photo) =>
                            getPhotoZone(photo).toLowerCase() ===
                            zone.id.toLowerCase(),
                        ),
                      );
                      return zonesWithPhotos.map((zone, zoneIdx) => {
                        const zonePhotos = allReportPhotos.filter(
                          (photo) =>
                            getPhotoZone(photo).toLowerCase() ===
                            zone.id.toLowerCase(),
                        );
                        ...
                        return (
                          <div
                            key={zone.id}
                            className="space-y-4 flex flex-col text-left font-sans"
                          >
                            <div className="space-y-1.5 shrink-0 text-left">
                              <h3 className="text-[12.5px] font-black text-indigo-900 uppercase tracking-wider border-b border-slate-200 pb-1 flex items-center gap-2 font-sans">
                                <span className="bg-indigo-900 text-white text-[9px] w-5 h-5 rounded-full flex items-center justify-center font-bold">
                                  4.{zoneIdx + 1}
                                </span>
                              ...
                              {selectedReport?.photoEvidenceCustomTitle &&
                                selectedReport.photoEvidenceCustomTitle.trim() !==
                                  "" && (
                    ...
                    {(() => {
                      const recPhotos =
                        selectedReport.recommendationPhotos || [];
                      ...
                      return (
                        <div className="space-y-4 flex flex-col text-left font-sans">
                          <h3 className="text-[12.5px] font-black text-amber-800 uppercase tracking-wider border-b border-amber-250 pb-1 flex items-center gap-2 font-sans">
                            <span className="bg-amber-800 text-white text-[9px] w-4.5 h-4.5 rounded-full flex items-center justify-center font-bold">
                              5.1
                            </span>
                            <span>
                              {t(
                                `Recommended Action Images:`,
                                `রিকমেন্ডেশন এবং সংশোধন রেফারেন্স ছবিসমূহ:`,
                                `صور الإجراءات الوقائية الموصى بها:`,
                              )}
                            </span>
                          </h3>
                          {/* Photos grid */}
                              ...
                              <div
                                ...
                                onClick={() =>
                                  setActiveZoomPhoto({
                                    url: item.url,
                                    caption:
                                      item.caption || `Recommendation proof`,
                                    videoUrl: item.videoUrl,
                                  })
                                }
                                style={{ breakInside: "avoid" }}
            ...
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs sm:text-sm font-black text-slate-200 uppercase tracking-widest font-mono">
                {activeZoomPhoto.source
                  ? t(
                      "🔍 Smart Interactive Image Editor (Direct Report Sync)",
                      "🔍 স্মার্ট ইমেজ এডিটর ও পরিবর্ধন (সরাসরি রিপোর্ট সিঙ্ক)",
                      "🔍 محرر الملاحظات الذكي للصور",
                    )
                  : t(
                      "🔍 Inspection Image Viewer",
                      "🔍 পরিদর্শন ইমেজ ভিউয়ার",
                      "🔍 عارض صور التفتيش",
                    )}
              </h3>
            </div>
                  ...
                  {!isBgLoaded && (
                    <div className="flex flex-col items-center justify-center h-72 w-96 text-slate-500 font-bold space-y-2 font-mono">
                      ...
                      <span className="text-xs uppercase">
                        {t(
                          "Preparing Editor canvas...",
                          "ক্যানভাস লোড হচ্ছে...",
                          "جاري تحميل محرر الصور...",
                        )}
                      </span>
                    </div>
                  )}
                      ...
                      {activeTool === "text" && (
                        <div className="flex items-center gap-2 bg-slate-950 p-2 rounded-xl border border-slate-800 w-full animate-fadeIn">
                          <span className="text-emerald-500 font-extrabold text-[10px] uppercase font-mono tracking-wider shrink-0 flex items-center gap-1">
                            <span>✍️</span>{" "}
                            {t("TEXT BAR:", "টেক্সট বার:", "سطر النص:")}
                          </span>
                          <input
                            type="text"
                            value={activeTextToDraw}
                            onChange={(e) =>
                              setActiveTextToDraw(e.target.value)
                            }
                            placeholder={t(
                              "Type custom text here to stamp on photo...",
                              "ছবিতে অঙ্কন করার জন্য এখানে টেক্সট লিখুন...",
                              "اكتب التسمية أو الملحوظة هنا...",
                            )}
          ...
          >
            ...
            <div className="space-y-1.5 pt-1">
              <label className="text-[10px] uppercase font-mono text-slate-400 tracking-wider font-extrabold flex items-center justify-between">
                <span>
                  {t(
                    "Select predefined or enter custom name:",
                    "পূর্বনির্ধারিত বা কাস্টম নাম লিখুন:",
                    "حدد اسمًا معرفًا مسبقًا أو أدخل اسمًا مخصصًا:",
                  )}
                </span>
              </label>
                ...
                >
                  <option value="" disabled>
                    {t(
                      ...
                      "-- প্রিডিফাইন্ড জোন নির্বাচন করুন --",
                      "-- اختر منطقة محددة مسبقا --",
                    )}
                  </option>
                  {AVAILABLE_ADDABLE_CATEGORIES.map((cat) => (
                    <option
                      key={cat.id}
                      value={t(cat.labelEN, cat.labelBN, cat.labelAR)}
                    >
                  ...
                  >
                    {t("Reception Area", "রিসেপশন এরিয়া", "منطقة الاستقبال")}
                  </option>
                  <option
                    value={t("Meeting Room", "মিটিং রুম", "غرفة الاجتماعات")}
                  >
                    {t("Meeting Room", "মিটিং রুম", "غرفة الاجتماعات")}
                  </option>
                  <option value={t("Cafeteria", "ক্যাফেটেরিয়া", "كافتيريا")}>
                    {t("Cafeteria", "ক্যাফেটেরিয়া", "كافتيريا")}
                  </option>
                  <option
                    value={t(
                      "Basement Parking",
                      "বেসমেন্ট পার্কিং",
                      "مواقف سيارات في القبو",
                    )}
                  >
                    {t(
                      "Basement Parking",
                  ...
                  <option
                    value={t(
                      ...
                      "ইলেকট্রিক্যাল ও পাম্প রুম",
                      "غرفة الكهرباء والمضخات",
                    )}
                  >
                    {t(
                      "Electrical & Pump Room",
                  ...
                  <option
                    value={t(
                      "Server & IT Room",
                      "সার্ভার ও আইটি রুম",
                      "غرفة الخوادم وتكنولوجيا المعلومات",
                    )}
                  >
                    {t(
                      "Server & IT Room",
                  ...
                  >
                    {t("Storage Facility", "স্টোরেজ সুবিধা", "مرفق التخزين")}
                  </option>
                  <option
                    value={t(
                      "Exterior Perimeter / Boundary",
                      "বহিঃসীমানা ও বাউন্ডারি",
                      "المحيط الخارجي / الحدود",
                    )}
                  >
                    {t(
                      "Exterior Perimeter / Boundary",
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                ...
                onClick={() => {
                  const trimmed =
                    newSlotInput.trim() || slotToCreate.defaultVal;
                  if (trimmed) {
                    ...
                    const matchedCat = AVAILABLE_ADDABLE_CATEGORIES.find(
                      (cat) => {
                        return (
                          cleanString(cat.id) === cleanTrimmed ||
                    ...
                    if (matchedCat) {
                      const alreadyActive = activeZones.some(
                        (z) =>
                          z.id.toLowerCase() === matchedCat.id.toLowerCase(),
                      );
                      if (!alreadyActive) {
                        setDynamicZones((prev) => {
                          if (
                      ...
                      if (
                        !activeZones.some(
                          (z) => z.id.toLowerCase() === trimmed.toLowerCase(),
                        )
                      ) {
                        setDynamicZones((prev) => [
                          ...prev,
        ...
        <div className="fixed inset-0 z-[120] flex flex-col bg-slate-950 select-none print:hidden overflow-hidden">
          ...
          <div className="absolute top-14 right-4 z-10">
            <span className="text-[10px] font-mono px-2.5 py-1.5 bg-emerald-500/20 backdrop-blur border border-emerald-500/50 text-emerald-400 rounded-lg font-bold shadow-lg">
              {language === "bn"
                ? `নতুন ছবি: ${cameraActiveCount} টি`
                : `Added index: ${cameraActiveCount}`}
            </span>
          </div>
          ...
          <div className="relative flex-1 w-full bg-black flex items-center justify-center">
            ...
            {isRecordingVideo && (
              <div className="absolute top-24 right-4 z-10 flex items-center gap-1.5 bg-slate-950/80 backdrop-blur px-3 py-1.5 rounded-lg border border-rose-500/50 shadow-lg">
                ...
                <span className="text-rose-400 font-mono text-[11px] font-bold uppercase tracking-widest">
                  {recordingDuration}s
                </span>
              </div>
            )}
          ...
          <div className="absolute bottom-0 left-0 right-0 z-30 bg-slate-950/90 backdrop-blur-md pt-4 px-6 pb-6 lg:pb-8 flex justify-between items-center w-full min-h-[100px] border-t border-slate-800/50 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
            ...
            <div className="flex justify-center items-center gap-6">
              ...
              >
                <div
                  className={`w-8 h-8 flex items-center justify-center transition-all ${isRecordingVideo ? "rounded bg-rose-600" : "rounded-full bg-slate-700 hover:bg-slate-600"} text-white`}
                >
                  <Video
                    className={`w-4 h-4 text-white ${isRecordingVideo ? "animate-bounce" : ""}`}
                  />
                </div>
              </button>
                ...
                <div className="text-left">
                  <h4 className="text-sm font-black uppercase font-mono tracking-wider text-slate-100">
                    {t(
                      ...
                      "সার্ভিসের তালিকা ব্যবস্থাপনা",
                      "إدارة قائمة الخدمات",
                    )}
                  </h4>
                  <p className="text-[9px] text-blue-400 font-bold uppercase tracking-widest mt-0.5">
                    {t(
                      "Customize service type options",
                      "নতুন ধরণের সার্ভিস যোগ বা সংশোধন করুন",
                      "تخصيص خيارات نوع الخدمة",
                    )}
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder={t(
                    "e.g. Bedbug Treatment, Fogging...",
                    "উদা: বেডবাগ ট্রিটমেন্ট, ফগিং ও স্প্রে...",
                    "مثال: مكافحة بق الفراش...",
                  )}
            ...
            <div className="space-y-2 text-left">
              <span className="text-[10px] text-slate-400 font-bold font-mono uppercase tracking-wider block">
                {t(
                  ...
                  "বর্তমানে সচল সার্ভিস সমূহের তালিকা:",
                  "قائمة أنواع الخدمات الحالية",
                )}
              </span>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {stVal}{" "}
                        {serviceType === stVal && (
                          <span className="text-emerald-400 ml-1.5 font-mono text-[9px] uppercase font-black">
                            ✓
                          </span>
                        )}
                      </button>
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (
                              confirm(
                                t(
                                  `Are you sure you want to delete "${stVal}" type?`,
                                  `আপনি কি নিশ্চিত যে "${stVal}" সার্ভিস অপশনটি তালিকা থেকে ডিলিট করতে চান?`,
                                  `هل أنت متأكد من حذف خدمة "${stVal}"؟`,
                                ),
                              )
                            ) {
                              setCustomServiceTypes((prev) =>
                                prev.filter((item) => item !== stVal),
                              );

...
export const INITIAL_LOCATIONS_REGISTRY: LocationRegistryItem[] = [
  ...
  {
    id: "LOC-AUH-01",
    name: "GENETIC AND NEONATAL SCREENING DIAGNOSTIC CENTER.",
    emirate: "Abu Dhabi",
    mapUrl: "",
  },
  ...
  {
    id: "LOC-AJ-01",
    name: "AL MADINA HEALTH CENTER -AJMAN",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-02",
    name: "AL MANAMA HEALTH CENTER -AJMAN",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-03",
    name: "MUZEIRAH HEALTH CENTER -AJMAN",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-04",
    name: "AL HAMIDIYA CLINIC-AJMAN",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-05",
    name: "PUBLIC HEALTH CENTER-AJMAN",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-06",
    name: "DENTAL CLINIC-AJMAN",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-07",
    name: "AL MUSHEIRIF HEALTH CENTER -AJMAN",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-08",
    name: "MEDICAL STORE -AJMAN",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-09",
    name: "MAPLE CLINIC - AL JURF",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-10",
    name: "MAPLE CLINIC - AL RAWDAH",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-11",
    name: "MAPLE RED PHARMACY - AL RAWDAH",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-12",
    name: "MAPLE RED PHARMACY - AL NUAMIA",
    emirate: "Ajman",
    mapUrl: "",
  },
  {
    id: "LOC-AJ-13",
    name: "MAPLE RED PHARMACY - G+",
    emirate: "Ajman",
    mapUrl: "",
  },
  ...
  {
    id: "LOC-DXB-04",
    name: "EMARAT HEALTH SERVICE(SILICON)",
    emirate: "Dubai",
    mapUrl: "",
  },
  ...
  {
    id: "LOC-DXB-06",
    name: "AL AWIR HEALTH CENTER",
    emirate: "Dubai",
    mapUrl: "",
  },
  {
    id: "LOC-DXB-07",
    name: "AL ITTIHAD HEALTH CENTER",
    emirate: "Dubai",
    mapUrl: "",
  },
  {
    id: "LOC-DXB-08",
    name: "DUBAI DENTAL SPECIALISED CENTER",
    emirate: "Dubai",
    mapUrl: "",
  },
  {
  ...
  {
    id: "LOC-DXB-10",
    name: "AL MUHAISNA HEALTH CENTER",
    emirate: "Dubai",
    mapUrl: "",
  },
  {
  ...
  {
    id: "LOC-DXB-12",
    name: "NATIONAL RADIATION PROTECTION CENTER .",
    emirate: "Dubai",
    mapUrl: "",
  },
  {
    id: "LOC-DXB-13",
    name: "PREVENTIVE MEDICINE(AL BARAHA)",
    emirate: "Dubai",
    mapUrl: "",
  },
  {
    id: "LOC-DXB-14",
    name: "SMART SALEEM CITY WALK",
    emirate: "Dubai",
    mapUrl: "",
  },
  {
    id: "LOC-DXB-15",
    name: "SMART SALEEM KNOWLADGE VILLAGE",
    emirate: "Dubai",
    mapUrl: "",
  },
  {
    id: "LOC-DXB-16",
    name: "SMART SALEEM INDEX MALL",
    emirate: "Dubai",
    mapUrl: "",
  },
  ...
  {
    id: "LOC-DXB-18",
    name: "EMIRATES DRUG ESTABLISHMENT (LAB)",
    emirate: "Dubai",
    mapUrl: "",
  },
  ...
  {
    id: "LOC-FJ-02",
    name: "FUJAIRAH MEDICAL STORE",
    emirate: "Fujairah",
    mapUrl: "",
  },
  {
    id: "LOC-FJ-03",
    name: "FUJAIRAH PUBLIC HEALTH CENTER",
    emirate: "Fujairah",
    mapUrl: "",
  },
  ...
  {
    id: "LOC-RAK-01",
    name: "ABDULLAH BIN OMRAN HOSPITAL",
  ...
  {
    id: "LOC-RAK-03",
    name: "SHA'AM HOSPITAL",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-04",
    name: "AL MAERID HEALTH CENTER",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-05",
    name: "AL JEER HEALTH CENTER",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-06",
    name: "ABDULLAH BIN ALI AL HARHAN HEALTH CENTER",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-07",
    name: "AL JAZEERA AL HAMRAH HEALTH CENTER",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-08",
    name: "RAS AL KHAIMAH HEALTH CENTER",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-09",
    name: "AL NAKHEEL HEALTH CENTER",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-10",
    name: "EHS MEDICAL STORE - RAK",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-11",
    name: "EHS OFFICES - RAK",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  {
    id: "LOC-RAK-12",
    name: "PHYSIOTHERAPY & SPORTS CENTER",
    emirate: "Ras Al Khaimah",
    mapUrl: "",
  },
  ...
  {
    id: "LOC-SH-01",
    name: "RAK SPECIALIZED DENTAL CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
  ...
  {
    id: "LOC-SH-03",
    name: "KHORFAKKAN DENTAL CLINIC",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-04",
    name: "KALBA PUBLIC HEALTH",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-05",
    name: "KALBA DENTAL CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-06",
    name: "DIBBA PUBLIC HEALTH",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-07",
    name: "AL NAHWA HEALTH CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-08",
    name: "KUWAIT HOSPITAL- SHARJAH",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-09",
    name: "FAMILY HEALTH CENTER - SHARJAH",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-10",
    name: "BLOOD TRANSFUSION AND RESEARCH CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
  ...
  {
    id: "LOC-SH-14",
    name: "AL DHAID HEALTH CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-15",
    name: "AL DHAIDPUBLIC HEALTH CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-16",
    name: "AL MALIHA HEALTH CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-17",
    name: "AL THAMEED HEALTH CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-18",
    name: "AL MADAM HEALTH CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  {
    id: "LOC-SH-19",
    name: "NAZWA HEALTH CENTER",
    emirate: "Sharjah",
    mapUrl: "",
  },
  ...
  {
    id: "LOC-UAQ-02",
    name: "KHAZAN HEALTH CENTER-UAQ",
    emirate: "Umm Al Quwain",
    mapUrl: "",
  },
  {
    id: "LOC-UAQ-03",
    name: "DENTAL CLINIC -UAQ",
    emirate: "Umm Al Quwain",
    mapUrl: "",
  },
  {
    id: "LOC-UAQ-04",
    name: "PUBLIC HEALTH CENTER -UAQ",
    emirate: "Umm Al Quwain",
    mapUrl: "",
  },
  {
    id: "LOC-UAQ-05",
    name: "SALAMA HEALTH CENTER -UAQ",
    emirate: "Umm Al Quwain",
    mapUrl: "",
  },
  {
    id: "LOC-UAQ-06",
    name: "FALAJ AL MUALLA HEALTH CENTER -UAQ",
    emirate: "Umm Al Quwain",
    mapUrl: "",
  },
  {
    id: "LOC-UAQ-07",
    name: "RAFA HEALTH CENTER -UAQ",
    emirate: "Umm Al Quwain",
    mapUrl: "",
  },
];
...
export default function LocationsRegistry({
  ...
  const handleAddRow = (emirate: string) => {
    ...
    saveDocument("locations", newId, newRow).catch(console.warn);

    setSaveStatus(
      language === "bn"
        ? "নতুন লাইন যুক্ত হয়েছে!"
  ...
  const handleDeleteRow = (id: string) => {
    ...
    setSaveStatus(
      language === "bn"
        ? "লোকেশন সফলভাবে মুছে ফেলা হয়েছে!"
  ...
  const handleResetToFactory = () => {
    ...
    setSaveStatus(
      language === "bn"
        ? "সিস্টেম ডিফল্ট সফলভাবে রিস্টোর করা হয়েছে!"
        : "Restored to system defaults successfully!",
    );
    setTimeout(() => setSaveStatus(null), 2500);
  };
  ...
  const filteredLocs = locations.filter((loc) => {
    ...
    const matchesEmirate =
      emirateFilter === "ALL" ||
      (loc.emirate || "").toLowerCase() === (emirateFilter || "").toLowerCase();
  ...
  return (
    <div
      id="locations-registry-view"
      className="space-y-6 font-sans text-xs text-slate-150 pb-16"
    >
      {/* Top Title Banner */}
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <span className="text-[10px] bg-emerald-500/15 text-[#10B981] font-mono font-black uppercase rounded-full px-3 py-1 tracking-wider border border-emerald-500/30">
              {language === "bn"
                ? "মেডিকেল লোকেশন ও ম্যাপ রেজিস্ট্রি"
                : "Medical Locations & Map Registry"}
            </span>
            <h2 className="text-lg font-black text-slate-100 tracking-tight flex items-center gap-2 mt-2">
              ...
              <span>
                {language === "bn"
                  ? "লোকেশন ও ম্যাপ নির্দেশিকা (Excel Style)"
                  : "Active Locations Registry Ledger"}
              </span>
            </h2>
          ...
          <div className="flex items-center gap-2.5">
            ...
            >
              ...
              <span>
                {language === "bn" ? "ডিফল্ট তালিকা" : "Reset Standard"}
              </span>
            </button>
            ...
            >
              ...
              <span>
                {language === "bn" ? "নতুন লোকেশন যোগ" : "Add Location"}
              </span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 pt-6 border-t border-slate-705/40">
          <div className="relative">
            ...
            <input
              ...
              placeholder={
                language === "bn"
                  ? "হসপিটাল বা ম্যাপ লিংক খুঁজুন..."
                  : "Search hospital name or google maps url..."
              }
              value={searchTerm}
            ...
            return (
              ...
              >
                ...
                {emirateLocations.length === 0 ? (
                  <p className="text-[11px] text-slate-500 italic py-2 pl-2">
                    No hospitals matching search in this Emirate.
                  </p>
                ) : (
                    ...
                    <table className="w-full text-slate-200 text-left border-collapse table-auto text-[11px] font-medium min-w-[700px]">
                      <thead>
                        <tr className="bg-slate-950 text-slate-400 font-mono text-[9px] uppercase tracking-wider border-b border-slate-800">
                          <th className="py-2 px-3 border-r border-slate-800 w-12 text-center">
                            S.No
                          </th>
                          <th className="py-2 px-3 border-r border-slate-800 w-64">
                            {language === "bn"
                              ? "হাসপাতাল / ক্লিনিক নাম (এডিট করতে ক্লিক করুন)"
                              : "Hospital / Clinic Name (Click to edit)"}
                          </th>
                          <th className="py-2 px-3 border-r border-slate-800">
                            {language === "bn"
                              ? "গুগল ম্যাপ লিংক / কুঅর্ডিনেট"
                      ...
                      <tbody className="divide-y divide-slate-800">
                        {emirateLocations.map((loc, index) => (
                          <tr
                            key={loc.id}
                            className="hover:bg-slate-800/40 bg-slate-950/20 transition group"
                          >
